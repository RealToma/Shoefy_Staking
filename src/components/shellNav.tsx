		...
		return (
			<div className="navigation-wrapper">
				<div className="logo-wrapper">
					<a href="/home">
						<img src="images/updated-logo-title.svg" className="img-logo" alt="ShoeFy Finance" />
					</a>
				...
				<nav id="mainNav">
					...
					<div className="navigation-footer">
						<div className="mt-2">
							<a href="https://whitebit.com/trade-pro/SHOEFY_DECL?type=spot" className="btn btn-primary btn-block" target="_blank">{t('nav.buyonwhitebit')}</a>
						</div>
						<div className="mt-2">
